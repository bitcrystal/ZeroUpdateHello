  ...
  Dashboard = (function(superClass) {
    ...
    Dashboard.prototype.handleEnableAlwaysTorClick = function() {
      return Page.cmd("configSet", ["tor", "always"], (function(_this) {
        return function(res) {
          return Page.cmd("wrapperNotification", ["done", "Tor always mode enabled, please restart your ZeroNet to make it work.<br>For your privacyswitch to Tor browser and start a new profile by renaming the data directory."]);
        };
      })(this));
    };
...
(function() {
  ...
  FileList = (function(superClass) {
    ...
    FileList.prototype.render = function() {
      var site, sites, sites_connected, sites_favorited, sites_politics, sites_blogs, sites_services, sites_forums_boards, sites_chat, sites_video_images, sites_guides, sites_news, sites_porn, sites_other;
      ...
      sites_other = (function() {
        var i, len, results;
        results = [];
        for (i = 0, len = sites.length; i < len; i++) {
          site = sites[i];
          if (!site.favorite&&site.has_category&&site.category=='Other') {
            results.push(site);
          }
        }
        return results;
      ...
      sites_porn = (function() {
        ...
        for (i = 0, len = sites.length; i < len; i++) {
          site = sites[i];
          if (!site.favorite&&site.has_category&&site.category=='Porn') {
            results.push(site);
          }
        }
        return results;
      ...
      sites_news = (function() {
        ...
        for (i = 0, len = sites.length; i < len; i++) {
          site = sites[i];
          if (!site.favorite&&site.has_category&&site.category=='News') {
            results.push(site);
          }
        }
        return results;
      })();
      sites_guides = (function() {
        var i, len, results;
        results = [];
        for (i = 0, len = sites.length; i < len; i++) {
          site = sites[i];
          if (!site.favorite&&site.has_category&&site.category=='Guides') {
            results.push(site);
          }
        }
        return results;
      })();
      sites_video_images = (function() {
        var i, len, results;
        results = [];
        for (i = 0, len = sites.length; i < len; i++) {
          site = sites[i];
          if (!site.favorite&&site.has_category&&site.category=='Video, Images') {
            results.push(site);
          }
        }
        return results;
      ...
      sites_chat = (function() {
        ...
        for (i = 0, len = sites.length; i < len; i++) {
          site = sites[i];
          if (!site.favorite&&site.has_category&&site.category=='Chat') {
            results.push(site);
          }
        }
        return results;
      })();
      sites_forums_boards = (function() {
        var i, len, results;
        results = [];
        for (i = 0, len = sites.length; i < len; i++) {
          site = sites[i];
          if (!site.favorite&&site.has_category&&site.category=='Forums, Boards') {
            results.push(site);
          }
        }
        return results;
      })();
      sites_services = (function() {
        var i, len, results;
        results = [];
        for (i = 0, len = sites.length; i < len; i++) {
          site = sites[i];    
          if (!site.favorite&&site.has_category&&site.category=='Services') { 
            results.push(site);
          }
        }  
        return results;
      ...
      sites_blogs = (function() {
        var i, len, results;
        results = [];
        for (i = 0, len = sites.length; i < len; i++) {
          site = sites[i];
          if (!site.favorite&&site.has_category&&site.category=='Blogs') {
            results.push(site);
          }
        }
        return results;
      })();
      sites_politics = (function() {
        var i, len, results;
        results = [];
        for (i = 0, len = sites.length; i < len; i++) {
          site = sites[i];
          if (!site.favorite&&site.has_category&&site.category=='Politics') {
            results.push(site);
          }
        }  
        return results;
      ...
      sites_connected = (function() {
        ...
        for (i = 0, len = sites.length; i < len; i++) {
          site = sites[i];
          if (!site.favorite&&!site.has_category) {
            results.push(site);
          }
        }
      })();
      if (sites.length > 0 && sites[0].files.loaded === false) {
        ...
        if (sites_politics.length) {
          sites_politics = [sites_politics[0]];
        } else {    
          sites_politics = [];
        }
        if (sites_blogs.length) {
          sites_blogs = [sites_blogs[0]];
        } else {
          sites_blogs = [];
        }
        if (sites_other.length) {
          sites_other = [sites_other[0]];
        } else {
          sites_other = [];
        }
        if (sites_porn.length) {
          sites_porn = [sites_porn[0]];
        } else {
          sites_porn = [];
        }
        if (sites_news.length) {
          sites_news = [sites_news[0]];
        } else {
          sites_news = [];
        }
        if (sites_guides.length) {
          sites_guides = [sites_guides[0]];
        } else {
          sites_guides = [];
        }
        if (sites_services.length) {
          sites_services = [sites_services[0]];
        } else {
          sites_services = [];
        }
        if (sites_forums_boards.length) {
          sites_forums_boards = [sites_forums_boards[0]];
        } else {
          sites_forums_boards = [];
        }
        if (sites_chat.length) {
          sites_chat = [sites_chat[0]];
        } else {
          sites_chat = [];
        }
        if (sites_video_images.length) {
          sites_video_images = [sites_video_images[0]];
        } else {
          sites_video_images = [];
        }
      }
      ...
      return h("div#FileList", [
        this.renderSelectbar(), this.renderTotalbar(), this.bigfiles.render(), sites_blogs.slice(0, +this.display_limit + 1 || 9e9).map((function(_this) {
          return function(site) {
            return site.renderOptionalStats();
          };
        })(this)), sites_services.slice(0, +this.display_limit + 1 || 9e9).map((function(_this) {
          return function(site) {
            return site.renderOptionalStats();
          };
        })(this)), sites_forums_boards.slice(0, +this.display_limit + 1 || 9e9).map((function(_this) {
          return function(site) {
            return site.renderOptionalStats();
          };
        })(this)), sites_chat.slice(0, +this.display_limit + 1 || 9e9).map((function(_this) {
          return function(site) {
            return site.renderOptionalStats();
          };
        })(this)), sites_video_images.slice(0, +this.display_limit + 1 || 9e9).map((function(_this) {
          return function(site) {
            return site.renderOptionalStats();
          };
        })(this)), sites_guides.slice(0, +this.display_limit + 1 || 9e9).map((function(_this) {
          return function(site) {
            return site.renderOptionalStats();
          };
        })(this)), sites_news.slice(0, +this.display_limit + 1 || 9e9).map((function(_this) {
          return function(site) {
            return site.renderOptionalStats();
          };
        })(this)), sites_porn.slice(0, +this.display_limit + 1 || 9e9).map((function(_this) {
          return function(site) {
            return site.renderOptionalStats();
          };
        })(this)), sites_other.slice(0, +this.display_limit + 1 || 9e9).map((function(_this) {
          return function(site) {
            return site.renderOptionalStats();
          };
        })(this)), sites_politics.slice(0, +this.display_limit + 1 || 9e9).map((function(_this) {
          return function(site) {
            return site.renderOptionalStats();
          };
        })(this)), sites_favorited.slice(0, +this.display_limit + 1 || 9e9).map((function(_this) {
           return function(site) {
             return site.renderOptionalStats();
           };
